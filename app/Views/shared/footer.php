<footer class="flex flex-col sm:flex-row bg-blue dark:bg-red text-black dark:text-white justify-around">
    <nav class="text-center">
        <ul class="flex flex-col">
            <li class="font-bold text-md">Home</li>
            <li><a href="#!">Intro</a></li>
            <li class="font-bold text-md">About</li>
