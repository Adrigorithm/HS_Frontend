<nav>
    <ul class="flex flex-col bg-blue dark:bg-red text-center">
        ...
        <li>
            <a class="<?php if($title == 'About') {echo 'border-r-3 border-solid border-red';} ?> p-1 hover:bg-red hover:text-white hover:dark:bg-blue hover:dark:text-black flex fill-black dark:fill-white hover:fill-white dark:hover:fill-black" href="#!">
        ...
        <li>
            <a class="<?php if($title == 'Projects') {echo 'border-r-3 border-solid border-red';} ?> p-1 hover:bg-red hover:text-white hover:dark:bg-blue hover:dark:text-black flex fill-black dark:fill-white hover:fill-white dark:hover:fill-black" href="#!">
        ...
        <li>
            <a class="<?php if($title == 'Contact') {echo 'border-r-3 border-solid border-red';} ?> p-1 hover:bg-red hover:text-white hover:dark:bg-blue hover:dark:text-black flex fill-black dark:fill-white hover:fill-white dark:hover:fill-black" href="#!">
